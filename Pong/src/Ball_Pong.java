...
public class Ball_Pong {
	...
	public Ball_Pong( double moveChange ) {
...
//		dy = rng.nextInt(4) + 1;
	...
	public void updateImage(boolean yesCollision ) {
		...
		if (yesCollision) {
			imageURL = new ImageIcon("src/art assets/newBall.png");
		} else {
			imageURL = new ImageIcon("src/art assets/Ball.png");
		}
